...
@register_processor("Qwen3OmniMoeProcessor")
class Qwen3OmniMoeDataProcessor(BaseQwen2_5_DataProcessor):
    ...
    def audio_processor(self):
        # For Qwen3-Omni MoE, audio processing is done via feature_extractor
    ...
    def sampling_rate(self):
        # Qwen3-Omni MoE uses feature_extractor instead of audio_processor
    ...
    def process(
        ...
        **kwargs,
        ...
        if hasattr(self.processor, "_merge_kwargs"):
            # Import the correct ProcessorKwargs for Qwen3-Omni
        ...
        # Pop Qwen3-Omni MoE specific parameters from videos_kwargs
        ...
        if videos is not None:
            ...
            if isinstance(fps, (int, float)):
                ...
                raise ValueError(
                    ...
                    f"must be equal to the length of video_grid_thw ({len(video_grid_thw)}) "
                    f"or fps should be a single number."
                )
